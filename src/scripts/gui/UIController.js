    ...
    _keydownHandler(event) {
        switch (event.keyCode) {
            ...
            case 32: // Space
                ...
                break
            case 9: // Tab
                this._setToolWithId(UIController.buttonIdList[(UIController.buttonIdList.indexOf(this.currentToolSelected) + 1) % UIController.buttonIdList.length])
                event.stopPropagation()
